 	...
 	c.fn.bPopup=function(A,E){
 		function L(){
 			...
 			switch(a.content){
 				...
 				case "image":B();
	 				c("<img />").load(function(){
	 					l(a.loadCallback);
	 					F(c(this))}).attr("src",a.loadUrl).hide().appendTo(a.contentContainer);
 				break;
 		...
 		function B(){
 			...
 			b.data("bPopup",a).data("id",e).css({
 				...
 				"z-index":a.zIndex+v+1}).each(function(){
 			...
 			if(h.x||h.y)clearTimeout(J),
 				J=setTimeout(function(){
 					...
 					b.dequeue().each(function(){
 						g?c(this).css({left:x,top:z}):c(this).animate(e,d,a.followEasing)})},50)
 		}
 		function F(d){
 			...
 			t=b.outerHeight(!0);u=b.outerWidth(!0);
 			C();
 			a.contentContainer.css({height:"auto",width:"auto"});
 			f.left=m(!(!a.follow[0]&&n||g));
 			f.top=p(!(!a.follow[1]&&q||g));
 			b.animate(f,250,function(){d.show();h=D()})
 		}
 		function M(){
 			k.data("bPopup",v);
 		...
 		function G(d){
 			function c(e){
 				b.css({display:"block",opacity:1}).animate(e,a.speed,a.easing,function(){K(d)})
 			}
 			switch(d?a.transition:a.transitionClose||a.transition){
 				...
 				break;
 				default:b.stop().fadeTo(a.speed,d?1:0,function(){K(d)})}
 		}
 		function K(d){
 		...
 		function C(){
 			...
 			x=n?a.position[0]:(w-b.outerWidth(!0))/2;h=D()
 		}
 		function D(){
 		...
 		var b=this,f=c(document),k=c(window),y=k.height(),w=k.width(),N=/OS 6(_\d)+/i.test(navigator.userAgent),v=0,e,h,q,n,g,z,x,t,u,J,H;b.close=function(){r()};
